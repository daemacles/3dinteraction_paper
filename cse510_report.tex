...
%\title{Adding IoT smarts to everyday objects with \sys}
%\title{Smartifying everyday objects with \sys}
%\title{\sys: Simplifying Input Devices for the Internet of Things}
